...
const TestComponent = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => updateProfile({ fullName: 'Updated Name' })} data-testid="update-profile">Update Profile</button>
    </div>
  );
};
...
describe('ProfileContext', () => {
  it('should provide profile data', () => {
    ...
    expect(screen.getByTestId('profile-name')).toHaveTextContent('Fatiha Barkah Mubyara');
  });
