...
describe('SplashScreen', () => {
  ...
  it('should have correct container styling', () => {
    ...
    expect(splashContainer).toHaveClass('fixed', 'inset-0', 'z-[100]', 'bg-background', 'flex', 'items-center', 'justify-center');
  });
  ...
  it('should have correct brand name styling', () => {
    ...
    expect(brandName).toHaveClass('mt-6', 'font-display', 'text-2xl', 'font-semibold', 'text-foreground', 'tracking-wide');
  });
