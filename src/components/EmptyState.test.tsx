...
describe("EmptyState", () => {
  ...
  it("should render icon with correct size and classes", () => {
    render(<EmptyState icon={ShoppingCart} title="Empty" />);
  ...
  it("should render without description when not provided", () => {
    render(<EmptyState icon={ShoppingCart} title="No items" />);
  ...
  it("should have correct container styling", () => {
    const { container } = render(
      <EmptyState icon={ShoppingCart} title="Test" />,
    );
  ...
  it("should have correct title styling", () => {
    render(<EmptyState icon={ShoppingCart} title="Test Title" />);
